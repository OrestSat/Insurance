var MyApp = angular.module("MyApp",['ngResource', 'ngRoute', 'Devise', 'ui.router', 'ng-context-menu', 'ui.bootstrap']);
...
MyApp.config(["$stateProvider", "$urlRouterProvider", "$locationProvider",function($stateProvider, $urlRouterProvider, $locationProvider){
	...
	$stateProvider
	  ...
	  .state ('home.new_insurance', {
	  	url:"/new_insurance",
	  	views: {
	  		"mainContent": {
	  			templateUrl: "assets/insurance/new_insurance.html",
	  			controller: "InsuranceController"
	  		}
	  	}
	  })
	  ...
	  .state('users_edit', {
	  	url: "/users_room",
	  	templateUrl: "assets/user/users_list.html",
